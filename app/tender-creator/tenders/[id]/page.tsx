...
export default function TenderCreatorTenderDetail({ params }: { params: { id: string } }) {
  ...
  const handleAwardTender = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        router.push("/tender-creator/tenders")
      }, 1000)
    } catch (error) {
