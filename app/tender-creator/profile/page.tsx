...
export default function TenderCreatorProfile() {
  ...
  const [profileData, setProfileData] = useState({
    firstName: "Tender",
    lastName: "Creator",
    email: "creator@tms.com",
    phone: "+1 (555) 987-6543",
    address: "456 Creator Ave, City, State 12345",
    bio: "Experienced tender creator specializing in construction and IT projects.",
