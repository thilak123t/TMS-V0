...
export default function TenderManagement() {
  ...
  const handleCreateTender = async (isDraft = false) => {
    ...
    try {
      ...
      setUploadedFiles([])
      setSelectedVendors([]) // Add this line
      setVendorSearchTerm("") // Add this line
      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-muted-foreground">Create and manage all tenders in the system</p>
          </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Manage and track all tenders in your system</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex flex-col sm:flex-row gap-4 mb-6">
              <div className="flex items-center gap-2 flex-1">
                ...
                <Input
                  placeholder="Search tenders by title or creator..."
                  value={searchTerm}
                ...
                <TableBody>
                  {filteredTenders.map((tender) => (
                    <TableRow key={tender.id}>
                      ...
                      <TableCell>{tender.creator}</TableCell>
                      <TableCell>
                        ...
                        <div className="flex justify-end gap-2">
                          ...
                          <Button
                            ...
                            onClick={() => {
                              ...
                              router.push(`/admin/tenders/${tender.id}/edit`)
                            }}
                          >
